...
async function clickStart() {
  ...
  {
    writer.write("mlx90384_measurement_onoff on\r");
    butStart.innerHTML = "Stop";
  }
  else if (butStart.innerHTML === "Stop")
  {
    writer.write("mlx90384_measurement_onoff off\r");
...
async function clickInfo() {
  ...
  writer.write("mlx90384_ops_ctrl 258\r");
...
async function clickReset() {
  ...
  writer.write("mlx90384_ops_ctrl 257\r");
...
function set_zero_position(event) {
  ...
  if (event.keyCode === 13) {
    writer.write("mlx90384_ops_ctrl 265 " + zeroposition.value + '\r'); //RT_SENSOR_CTRL_USER_CMD_SET_ZEROPOSITION = 265
    // zeroposition.value = ''
  }
...
async function changeSampleFreq() {
  ...
  writer.write("mlx90384_set_sample_freq " + sampleFreq.value + '\r');
...
async function changeSensingMode() {
  ...
  writer.write("mlx90384_ops_ctrl 266 " + sensingMode.value + '\r');
